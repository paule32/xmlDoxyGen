...
<div class="doxy-docs">
  ...
  <div class="doxy-grid doxy-section-gap">
    ...
    <div class="doxy-card"><h3>Typen</h3><p class="doxy-muted">Klassen- und Namespace-Listen sowie Detailseiten.</p><p><a href="classes.html">Klassen</a> · <a href="namespaces.html">Namespaces</a></p></div>
  </div>
</div>
</xsl:template>
</xsl:stylesheet>
